...
#define STRING_CONFIG_H_AUTHOR "(garygnu_fresh_skr 1.4T for CR-10 S5 3_3_21)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Gary Super S5 Turbo"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -43,-3, -2.4 }
